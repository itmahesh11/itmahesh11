...
import com.ars.ODCC.Connection.ODMessage.Subscribe.DisplayProperties.Builder;
...
public class TestProtoToJson {
	...
	public static void main(String[] args) {
		...
		client.publishWith().topic("travel_information/2/2/SUR/34134134").qos(MqttQos.AT_LEAST_ONCE).payload(createContainerMessage().toByteArray()).send();
	...
	public static com.ars.ODCC.Connection.ODMessage.Subscribe.FilterParameters.Builder getFilterParametersObject() {
		FilterParameters.Builder filterParameters = FilterParameters.newBuilder();
